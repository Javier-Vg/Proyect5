...
function CardsAbout() {
  return (
    ...
    <Card style={{ width: '18rem' }}>
      ...
      <Card.Body>
        <Card.Title style={{fontFamily:"sans-serif", fontSize: "25px"}}>Armamos PCs</Card.Title>
        <Card.Text>
    ...
    <Card style={{ width: '18rem' }}>
      ...
      <Card.Body>
        <Card.Title style={{fontFamily:"sans-serif", fontSize: "25px"}}>Mercado de computadoras</Card.Title>
        <Card.Text>
    ...
    <Card style={{ width: '18rem' }}>
      ...
      <Card.Body>
        <Card.Title style={{fontFamily:"sans-serif", fontSize: "25px"}}>Componentes en buen estado</Card.Title>
        <Card.Text>
