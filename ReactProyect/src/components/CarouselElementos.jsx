...
function CarouselElementos() {
    ...
    const items = [
        ...
        <div className='divElementosCarusel'>RATONES</div>
        </>
        
        ,
        <>
            <div className="item" >
                <img style={{backgroundColor: "grid" ,height: "380px", width:"350px", position: "relative"}} src={teclado} alt="teclado" />
                
            </div>
            <div className='divElementosCarusel'>TECLADOS</div>
        </>
        ...
        <div className='divElementosCarusel'>MICROFONOS</div>
        </>
        ...
        <div className='divElementosCarusel'>CAMARAS</div>
        </>
        ,
        <>
         <div className="item" >
        ...
        <div className='divElementosCarusel'>MONITORES</div>
        </>
       ,
       <>
       <div className="item" >
        ...
        <div className='divElementosCarusel'>GABINETES</div>
       </>
        ,
        <>
        <div className="item" >
        ...
        <div className='divElementosCarusel'>FUENTE DE ALIMENTACION</div>
        </>
        ,
        <>
        <div className="item" >
        ...
        <div className='divElementosCarusel'>AUDIO</div>
        </>
        ,  
        <>
        <div className="item" >
        ...
        <div className='divElementosCarusel'>MANDOS</div>
        </>
        , 
        <>
        <div className="item" >
        ...
        <div className='divElementosCarusel'>SILLAS</div>
        </>
