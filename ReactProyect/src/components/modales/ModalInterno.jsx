...
const ModalInterno = ({ id, isOpen, closeModal }) => {//Se pasa como propiedad el id, una confirmacion de que el modal esta activado y otra si esta desactivado
  ...
  return (
    <>
      ...
      <div className="modal">
        ...
        <AiOutlineClose size={30} color="white" onClick={closeModal} />
        ...
        <div className="containerr">
          <button
            ...
            onClick={borrar}
          >
            <img src={basura} alt="trash" />
          </button>
          <button style={{ background: "none", border: "none" }} onClick={edit}>
